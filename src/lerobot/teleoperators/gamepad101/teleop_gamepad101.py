...
from .configuration_gamepad101 import Gamepad101TeleopConfig
...
class Gamepad101Teleop(Teleoperator):
    """
    Teleop class to use gamepad inputs for control.
    """

    config_class = Gamepad101TeleopConfig
    name = "gamepad101"

    def __init__(self, config: Gamepad101TeleopConfig):
    ...
    def connect(self) -> None:
        ...
        if sys.platform == "darwin":
            ...
            from .gamepad101_utils import GamepadController as Gamepad
    ...
    def get_action(self) -> RobotAction:
        ...
        shoulder_pan, shoulder_lift, elbow_flex, wrist_flex, wrist_roll, gripper = self.gamepad.get_deltas()
        #delta_x, delta_y, delta_z = self.gamepad.get_deltas()

        # Create action from gamepad input
        gamepad_action = np.array([shoulder_pan, shoulder_lift, elbow_flex, wrist_flex, wrist_roll, gripper], dtype=np.float32)

        action_dict = {
            "delta_shoulder_pan": gamepad_action[0],
            "delta_shoulder_lift": gamepad_action[1],
            "delta_elbow_flex": gamepad_action[2],
            "delta_wrist_flex": gamepad_action[3],
            "delta_wrist_roll": gamepad_action[4],
            "delta_gripper": gamepad_action[5],
        }
